...
public class Dialogs {
    private static PrefUserDetails.UserGender gender;
    private static int weight;

    //private static final String TAG="Diaogs>>";

    public interface OnGenderSelectedListener {
        void onUserSelected(PrefUserDetails.UserGender gender);
    }
    ...
    public static void showGenderDialog(@NonNull View root, @NonNull final OnGenderSelectedListener listener) {
        ...
        v.findViewById(R.id.dif_ibt_man).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                gender = PrefUserDetails.UserGender.MALE;
        ...
        v.findViewById(R.id.dif_ibt_woman).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gender = PrefUserDetails.UserGender.FEMALE;
    ...
    public interface OnUserActivitySelectedListener {
        void onUsrActivitySelected(PrefUserDetails.UserActivity activity);
    }
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        switch (rg.getCheckedRadioButtonId()) {
                            case R.id.dif_rb_lots:
                                listener.onUsrActivitySelected(PrefUserDetails.UserActivity.LOTS);
                                break;
                            case R.id.dif_rb_some:
                                listener.onUsrActivitySelected(PrefUserDetails.UserActivity.SOME);
                                break;
                            case R.id.dif_rb_few:
                                listener.onUsrActivitySelected(PrefUserDetails.UserActivity.AFEW);
                                break;
                            case R.id.dif_rb_none:
                                listener.onUsrActivitySelected(PrefUserDetails.UserActivity.NONE);
                                break;
