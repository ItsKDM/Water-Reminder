...
public class ServicesHandler {
    ...
    public static void  updateServices(Context ctx){
        ...
        boolean showNotifs=prefMain.getBoolean(PrefUserDetails.KEYS.KEY_SHOW_NOTIFS, PrefUserDetails.Defaults.SHOW_NOTIF);
        boolean showLogs=prefMain.getBoolean(PrefUserDetails.KEYS.KEY_SHOW_LOGS, PrefUserDetails.Defaults.SHOW_LOGS);
