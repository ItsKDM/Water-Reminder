package com.example.kdm.water.ui.screen_intro;
...
import com.example.kdm.water.services.ServicesHandler;
import com.example.kdm.water.ui.custom.WaveLoadingView;
import com.example.kdm.water.ui.screen_dashboard.DashBoardActivity;
...
import static com.example.kdm.water.db.pref.PrefUserDetails.PREF_NAME;
...
public class TakeInfoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull final View rootView, @Nullable Bundle savedInstanceState) {
        ...
        ibtMan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                putInfoInPref(PrefUserDetails.KEYS.KEY_GENDER, PrefUserDetails.UserGender.MALE);
            }
        });
        ibtWomen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                putInfoInPref(PrefUserDetails.KEYS.KEY_GENDER, PrefUserDetails.UserGender.FEMALE);
        ...
        wheelView.setOnWheelItemSelectedListener(new WheelView.OnWheelItemSelectedListener() {
            ...
            public void onWheelItemSelected(WheelView wheelView, int position) {
                putInfoInPref(PrefUserDetails.KEYS.KEY_WEIGHT, position);
        ...
        btLots.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                putInfoInPref(PrefUserDetails.KEYS.KEY_ACTIVITY, PrefUserDetails.UserActivity.LOTS);
        ...
        btSome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                putInfoInPref(PrefUserDetails.KEYS.KEY_ACTIVITY, PrefUserDetails.UserActivity.SOME);
        ...
        btFew.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                putInfoInPref(PrefUserDetails.KEYS.KEY_ACTIVITY, PrefUserDetails.UserActivity.AFEW);
        ...
        btNone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                putInfoInPref(PrefUserDetails.KEYS.KEY_ACTIVITY, PrefUserDetails.UserActivity.NONE);
            }
        });
        ...
        btContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!allBoxesShown) {
                    ...
                    putInfoInPref(PrefUserDetails.KEYS.KEY_DATE_TODAY, TimeUtilities.getCurrentDate());
                    putInfoInPref(PrefUserDetails.KEYS.KEY_SHOWN_INFO_ACTIVITY,true);
                    putInfoInPref(PrefUserDetails.KEYS.KEY_SHOW_NOTIFS,true);
                    putInfoInPref(PrefUserDetails.KEYS.KEY_SHOW_LOGS,true);
            ...
            public void onTimeSet(TimePicker timePicker, int hr, int min) {
                ...
                if (prefBasicInfo != null) {
                    if (sleepOrWake == KEY_TIME.SLEEP_TIME) {
                        putInfoInPref(PrefUserDetails.KEYS.KEY_SLEEP_TIME, timeFormatted);
                    } else {
                        putInfoInPref(PrefUserDetails.KEYS.KEY_WAKEUP_TIME, timeFormatted);
                    }
                }
            }
        };
        ...
        dialogBuilder
                ...
                .setPositiveButton("PROCEED", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        putInfoInPref(PrefUserDetails.KEYS.KEY_DAILY_TARGET, dailyIntake);
    ...
    private int calculateWaterCapacity() {
        ...
        int weight = PrefUserDetails.Defaults.WEIGHT;
        PrefUserDetails.UserActivity activity = PrefUserDetails.UserActivity.valueOf(PrefUserDetails.Defaults.USER_ACTIVITY);
        PrefUserDetails.UserGender userGender = PrefUserDetails.UserGender.valueOf(PrefUserDetails.Defaults.GENDER);
        if (prefBasicInfo != null) {
            weight = prefBasicInfo.getInt(PrefUserDetails.KEYS.KEY_WEIGHT, PrefUserDetails.Defaults.WEIGHT);
            userGender = PrefUserDetails.UserGender.valueOf(prefBasicInfo.getString(PrefUserDetails.KEYS.KEY_GENDER, PrefUserDetails.Defaults.GENDER));
            activity =  PrefUserDetails.UserActivity.valueOf(prefBasicInfo.getString(PrefUserDetails.KEYS.KEY_ACTIVITY, PrefUserDetails.Defaults.USER_ACTIVITY));
        }
        int resultInMl;
    ...
    private void setUiData(SharedPreferences pref) {
        ...
        String genderEnum = PrefUserDetails.Defaults.GENDER;
        String dailyActivityEnum = PrefUserDetails.Defaults.USER_ACTIVITY;
        int weight = PrefUserDetails.Defaults.WEIGHT;
        String wakeupTime = PrefUserDetails.Defaults.WAKEUP_TIME;
        String sleepTime = PrefUserDetails.Defaults.SLEEP_TIME;
        if (pref != null) {
            weight = pref.getInt(PrefUserDetails.KEYS.KEY_WEIGHT, PrefUserDetails.Defaults.WEIGHT);
            genderEnum = pref.getString(PrefUserDetails.KEYS.KEY_GENDER, PrefUserDetails.Defaults.GENDER);
            wakeupTime = pref.getString(PrefUserDetails.KEYS.KEY_WAKEUP_TIME, PrefUserDetails.Defaults.WAKEUP_TIME);
            sleepTime = pref.getString(PrefUserDetails.KEYS.KEY_SLEEP_TIME, PrefUserDetails.Defaults.SLEEP_TIME);
            dailyActivityEnum = pref.getString(PrefUserDetails.KEYS.KEY_ACTIVITY, PrefUserDetails.Defaults.USER_ACTIVITY);
        }
    ...
    private void putInfoInPref(String key, Object value) {
        if (prefBasicInfo != null) {
            ...
            } else if (value instanceof PrefUserDetails.UserGender) {
                et.putString(key, ((PrefUserDetails.UserGender) value).name());
            } else if (value instanceof PrefUserDetails.UserActivity) {
                et.putString(key, ((PrefUserDetails.UserActivity) value).name());
            }
